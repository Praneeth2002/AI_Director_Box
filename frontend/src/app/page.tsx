        ...
        <section className="lg:col-span-2 space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-neutral-900/50 ring-1 ring-white/5 backdrop-blur-sm">
            ...
            <div className="flex gap-4">
              <button className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 transition-colors rounded-lg font-medium shadow-lg shadow-indigo-600/20 text-sm flex items-center gap-2">
